...
export function HeroBanner({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 space-y-5 md:w-[48%]">
        <p className="text-xs font-semibold uppercase tracking-[0.32em] text-accent">
          {subtitle}
        </p>
        <h1 className="text-4xl font-semibold leading-tight text-[var(--primary)] sm:text-[44px] lg:text-[52px] xl:text-[56px]">
          {title}
        </h1>
      ...
      {hasImage && image && (
        <div className="relative mt-12 flex w-full items-center justify-center md:mt-0 md:w-[52%] md:justify-end">
