...
export const landingPages: LandingPage[] = [
  {
    ...
    fullContent: true,
    seoTitle:
      "Epoxy Adhesive Supplier India | 2-Part Epoxy Resin for Industrial Bonding",
    seoDescription:
      "Industrial 2-part epoxy adhesive from Stick-Onn India. Structural bonding for metal-to-wood joints and heavy fabrication. Gap-filling epoxy resin systems.",
    keywords: [
      "epoxy adhesive India",
      "2 part epoxy adhesive",
      "epoxy resin manufacturer India",
      "structural epoxy bonding",
      "metal to wood epoxy",
      "industrial epoxy adhesive",
      "gap filling epoxy",
      "Stick-Onn epoxy resin",
      "heavy duty epoxy glue",
      "B2B epoxy adhesive supplier",
    ],
    h1: "Industrial 2-Part Epoxy Adhesive Supplier in India",
    intro:
      "When your assembly demands maximum structural strength — metal brackets on wood frames, load-bearing joints, gap-filled repairs, or substrates that reject conventional wood glues — Stick-Onn two-part epoxy adhesive systems deliver the chemical bond integrity that production engineers specify. Synergy Bonding Solutions formulates and supplies epoxy resin adhesives for Indian manufacturers, fabricators, and maintenance teams who need predictable mix ratios, workable pot life, and cured strengths measured in megapascals, not marketing claims.",
    rangeSectionTitle: "Epoxy Adhesive Range",
    productShowcaseTitle: "Stick-Onn Epoxy & Structural Products",
    midPageCta: {
      title: "Need help with structural bonding?",
      description:
        "Share your substrate combination and load requirements — our technical team will recommend the right epoxy or drill-free solution.",
      productName: "Epoxy Resin Adhesive",
    },
    bottomCta: {
      title: "Looking for a Trusted Epoxy Adhesive Supplier in India?",
      description:
        "From metal-to-wood joints to gap-filled repairs and hardware mounting, Stick-Onn delivers structural bonding systems backed by technical support. Contact us for product recommendations and bulk pricing.",
      productName: "Epoxy Resin Adhesive",
    },
    sections: [
      {
        title: "What is Epoxy Adhesive?",
        paragraphs: [
          "Two-part epoxy adhesive consists of a resin and hardener that react upon mixing, creating a thermoset bond unaffected by moisture after cure. This makes epoxy the preferred choice for structural joints, dissimilar material bonding, and applications where gap filling is essential.",
          "Key characteristics of epoxy adhesive include:",
        ],
        bullets: [
          "Exceptional structural strength for load-bearing and high-stress joints",
          "Bonds dissimilar materials — metal, wood, stone, glass, and composites",
          "Gap-filling capability on uneven or worn surfaces",
          "Chemical and moisture resistance after full cure",
          "Predictable mix ratios and workable pot life for shop-floor use",
        ],
      },
      {
        title: "Why Choose Stick-Onn as Your Epoxy Adhesive Supplier",
        paragraphs: [
          "Synergy Bonding Solutions formulates epoxy systems engineered for Indian manufacturing realities — with clear application guidance, bulk packaging, and responsive technical support.",
        ],
      },
      {
        title: "Structural Two-Part Epoxy Systems",
        layout: "card",
        paragraphs: [
          "Stick-Onn Epoxy Resin Adhesive delivers high tensile and shear strength for metal bonding, concrete repair, stone fixing, and industrial maintenance applications.",
        ],
      },
      {
        title: "Gap-Filling & Vertical Application",
        layout: "card",
        paragraphs: [
          "Thixotropic formulations stay in place on vertical surfaces and bridge gaps up to several millimetres without sagging — ideal for machinery mounts and uneven joints.",
        ],
      },
      {
        title: "Drill-Free Mounting Solutions",
        layout: "card",
        paragraphs: [
          "Stick-Onn Drill-Free adhesive anchors hardware, brackets, and fixtures without visible fasteners — complementing epoxy for interior fit-out and renovation projects.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Our bonding specialists validate epoxy applications through substrate testing, seasonal cure guidance, and line trials with your engineering team.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Reliable inventory and bulk packaging for manufacturers, fabricators, and maintenance teams across India through our dealer and direct supply network.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Every batch is supported by technical data sheets specifying tensile strength, shear strength, and recommended substrates for audit and export compliance.",
        ],
      },
      {
        title: "Applications of Stick-Onn Epoxy Adhesive",
        paragraphs: ["Stick-Onn epoxy systems are used across demanding applications, including:"],
        bullets: [
          "Furniture Manufacturing – hardware mounting blocks, metal leg attachments, and corner reinforcement",
          "Metal-to-Wood Bonding – brackets, inserts, and structural hybrid assemblies",
          "WPC & Composite Fabrication – hinge blocks, locking mechanisms, and metal inserts",
          "Construction & Maintenance – concrete repair, stone anchoring, and machinery base grouting",
          "Field Service & Retrofit – mixed-material repairs on cured wood and prepared painted surfaces",
        ],
      },
      {
        title: "Epoxy Adhesive Range",
        paragraphs: ["Stick-Onn's epoxy and structural bonding offering includes:"],
        bullets: [
          "Stick-Onn Epoxy Resin Adhesive – two-part structural epoxy for metal, concrete, and stone",
          "Stick-Onn Drill-Free Adhesive – high-grab construction adhesive for drill-free mounting",
          "Stick-Onn WPCfix – flexible composite bonding alongside epoxy structural joints",
        ],
      },
      {
        title: "Manufacturing Quality & Consistency",
        paragraphs: [
          "Synergy Bonding Solutions serves epoxy adhesive buyers across India with quality-controlled inventory, bulk packaging, and direct technical access to our formulation team. Bonding specialists work with your quality teams to validate applications before full-scale rollout.",
        ],
      },
    ],
    productSlugs: ["epoxy-resin", "drill-free", "wpcfix"],
    productShowcase: [
      {
      ...
      },
      {
        ...
        description:
          "Flexible composite bonding for WPC assemblies — complements epoxy on hybrid metal-to-composite builds.",
    ...
    faqs: [
      {
        question: "What is the mix ratio for Stick-Onn 2-part epoxy adhesive?",
        answer:
          "Mix ratios vary by product grade — typically 2:1 or 1:1 resin-to-hardener by volume or weight. Always refer to the specific product technical data sheet for the exact ratio, as incorrect mixing significantly reduces bond strength.",
      },
      {
        question: "Can epoxy adhesive bond metal to wood?",
        answer:
          "Yes. Two-part epoxy is one of the most reliable adhesives for metal-to-wood bonding. Proper surface preparation — degreasing metal and abrading both surfaces — is essential for maximum adhesion.",
      },
      {
        question: "How long does epoxy adhesive take to reach full strength?",
        answer:
          "Handling strength typically develops within 4–8 hours at room temperature, with full cure achieved in approximately 24 hours. Elevated temperatures accelerate cure; low temperatures extend cure time.",
      },
      {
        question: "Is Stick-Onn Drill-Free adhesive an epoxy system?",
        answer:
          "Stick-Onn Drill-Free is a structural bonding solution designed for fixture and hardware mounting without mechanical fasteners. Contact our technical team for substrate compatibility details and application guidelines.",
      },
      {
        question: "Do you supply epoxy adhesive in bulk for manufacturing lines?",
        answer:
          "Yes. Synergy Bonding Solutions offers bulk packaging options for industrial buyers. Reach out through our contact page for volume pricing, delivery schedules, and distributor partnerships.",
      },
    ],
    relatedLinks: [
  ...
  {
    slug: "spray-adhesive-india",
    fullContent: true,
    seoTitle:
      "Spray Adhesive India | Contact Spray for Furniture & Upholstery Manufacturing",
    seoDescription:
      "Contact spray adhesive from Stick-Onn India for furniture and upholstery. Even coverage, aggressive tack, low soak-in. B2B spray adhesive supplier India.",
    keywords: [
      "spray adhesive India",
      "contact spray adhesive",
      "upholstery spray glue",
      "furniture spray adhesive",
      "foam lamination adhesive",
      "aerosol spray glue",
      "industrial spray adhesive",
      "Stick-Onn AeroFix",
      "fabric bonding spray",
      "B2B spray adhesive supplier",
    ],
    h1: "Contact Spray Adhesive for Furniture, Upholstery, and Panel Lamination",
    intro:
      "Large-surface bonding demands a different tool than brush-applied wood glue. Stick-Onn contact spray adhesive delivers uniform coverage, instant tack, and clean bonds across foam, fabric, leather, insulation, and panel substrates — without the soak-through and wrinkling that liquid adhesives cause on porous materials. Synergy Bonding Solutions supplies AeroFix and complementary spray and hotmelt systems to upholstery manufacturers, furniture plants, and acoustic panel producers across India.",
    ...
    midPageCta: {
      ...
      description:
        "Share your substrates and coverage area — our team will recommend AeroFix or Lam2Lam for your upholstery or lamination line.",
      productName: "AeroFix Spray Adhesive",
    },
    bottomCta: {
      title: "B2B Spray Adhesive Supply for Indian Manufacturing",
      description:
        "From boutique upholstery workshops to multi-line furniture factories, Stick-Onn AeroFix delivers coverage consistency and adhesion performance. Request samples or schedule a product demonstration.",
      productName: "AeroFix Spray Adhesive",
    },
    sections: [
      {
        title: "What is Contact Spray Adhesive?",
        paragraphs: [
          "Contact spray adhesive applies as a fine mist that creates a uniform tack layer across large surfaces — bonding on contact once solvent flash-off completes. Unlike brush-applied glues, spray adhesive covers square metres in seconds without soak-through on foam and fabric.",
          "Key characteristics of spray adhesive include:",
        ],
        bullets: [
          "Fine mist pattern for even coverage on foam, fabric, and panels",
          "Aggressive tack with a practical repositioning window",
          "Low soak-in to prevent strike-through on light-coloured fabrics",
          "Instant bond formation for high-volume upholstery and lamination lines",
          "Available in aerosol and bulk formats for every shop size",
        ],
      },
      {
        title: "Why Choose Stick-Onn as Your Spray Adhesive Supplier",
        paragraphs: [
          "Stick-Onn AeroFix is engineered for the coverage consistency and adhesion aggressiveness that high-volume upholstery, furniture, and acoustic panel shops require.",
        ],
      },
      {
        title: "Uniform Coverage & Aggressive Tack",
        layout: "card",
        paragraphs: [
          "AeroFix delivers fine mist spray patterns with consistent tack — reducing rework from uneven coats, weak bonds, or fabric bleed-through.",
        ],
      },
      {
        title: "Low Soak-In Protection",
        layout: "card",
        paragraphs: [
          "Formulated to minimise adhesive strike-through on foam and light fabrics — protecting appearance on premium upholstery and automotive trim.",
        ],
      },
      {
        title: "Complete Bonding Portfolio",
        layout: "card",
        paragraphs: [
          "Combine AeroFix for broad-area lamination with Stick-Onn hotmelt for edge work and Lam2Lam for rigid laminate overlays from one supplier.",
        ],
      },
      {
        title: "Dedicated Technical Support",
        layout: "card",
        paragraphs: [
          "Application technique guidance, spray booth best practices, and product selection support from Stick-Onn's technical team.",
        ],
      },
      {
        title: "Pan-India Supply Network",
        layout: "card",
        paragraphs: [
          "Reliable inventory in 500 ml aerosol, 1 L, and 5 L bulk formats for workshops and factories across India.",
        ],
      },
      {
        title: "Consistent, Benchmarked Quality",
        layout: "card",
        paragraphs: [
          "Batch-to-batch consistency in spray pattern, tack development, and cured bond strength for production-critical consumables.",
        ],
      },
      {
        title: "Applications of Stick-Onn Spray Adhesive",
        paragraphs: ["Stick-Onn spray adhesives are used across applications, including:"],
        bullets: [
          "Upholstery & Soft Furnishing – foam-to-fabric, dacron wrap, and sofa manufacturing",
          "Acoustic Panel Assembly – uniform lamination of insulation and facing materials",
          "Automotive Interiors – trim bonding and headliner lamination",
          "Furniture Panel Lamination – foam-to-plywood and substrate bonding",
          "Graphic Arts & Signage – laminate overlays with Lam2Lam contact adhesive",
        ],
      },
      {
        ...
        bullets: [
          "Stick-Onn AeroFix – contact spray for foam, fabric, leather, and panel bonding",
          "Stick-Onn Lam2Lam – specialty contact adhesive for laminate-to-laminate and HPL work",
          "Stick-Onn Hotmelt – complementary point-bond and edge banding for mixed-technology lines",
        ],
      },
      {
        title: "Manufacturing Quality & Consistency",
        paragraphs: [
          "Synergy Bonding Solutions manufactures and distributes Stick-Onn spray adhesives with reliable inventory, technical support, and product consistency across batches for B2B buyers nationwide.",
        ],
      },
    ],
    ...
    faqs: [
      {
        question: "What surfaces can Stick-Onn AeroFix spray adhesive bond?",
        answer:
          "AeroFix bonds foam, fabric, leather, plywood, MDF, insulation materials, and many plastics. It is designed for upholstery, acoustic panels, automotive interiors, and general panel lamination applications.",
      },
      {
        question: "How do I avoid adhesive bleed-through on light fabrics?",
        answer:
          "Use light, even spray coats rather than heavy application. AeroFix is formulated with low soak-in to minimise strike-through. Test on a fabric swatch first and allow the recommended tack time before joining.",
      },
      {
        question: "Is spray adhesive better than hotmelt for upholstery?",
        answer:
          "Spray adhesive is preferred for large surface-area bonding such as foam-to-fabric wrapping. Hotmelt suits edge banding, point bonds, and automated dispensing. Most upholstery plants use both technologies.",
      },
      {
        question: "What pack sizes does AeroFix come in?",
        answer:
          "Stick-Onn AeroFix is available in 500 ml aerosol cans, 1 L containers, and 5 L bulk formats for shops with spray equipment and high-volume consumption.",
      },
      {
        question: "Can I use spray adhesive for laminate-to-laminate bonding?",
        answer:
          "For graphic lamination and laminate-to-laminate work, Stick-Onn Lam2Lam is the recommended product. AeroFix is optimised for foam, fabric, and panel bonding rather than rigid laminate overlays.",
      },
    ],
    relatedLinks: [
      { href: "/applications/upholstery-foam-fabric", label: "Upholstery and spray applications" },
      { href: "/applications/laminate-bonding", label: "Lamination and panel bonding" },
      { href: "/applications/automotive-interior", label: "Automotive interior bonding" },
      { href: "/contact", label: "Request spray adhesive samples or pricing" },
    ],
  },
  {
    ...
    seoDescription:
      "Stick-Onn is a trusted hot melt adhesive manufacturer in India, supplying high-performance bonding solutions for furniture, packaging & industrial use. Get a quote today.",
    keywords: [
      "hot melt adhesive manufacturer India",
      "hot melt glue supplier",
      "hot melt adhesive manufacturer",
      "edge banding hot melt",
      "industrial hot melt adhesive",
      "EVA hot melt adhesive India",
      "hot melt glue manufacturer",
      "Stick-Onn hot melt",
      "furniture hot melt adhesive",
      "packaging hot melt glue India",
    ],
    ...
    midPageCta: {
      title: "Need a formulation consultation?",
      description:
        "Share your substrate and production line details — our technical team will recommend the right hot melt grade.",
      productName: "Hot Melt Adhesive",
    },
    bottomCta: {
      title: "Looking for a Hot Melt Adhesive Supplier You Can Depend On?",
      description:
        "Whether you're a furniture manufacturer, packaging unit, or industrial fabricator, Stick-Onn provides the technical backing and product consistency needed to keep your production line moving. Get in touch for a formulation consultation or product trial.",
      productName: "Hot Melt Adhesive",
    },
    sections: [
      {
        ...
        paragraphs: [
          "Hot melt adhesive is a thermoplastic bonding agent that is solid at room temperature and melts into a workable liquid when heated. Once applied, it cools rapidly to form a strong, durable bond — making it ideal for high-speed production lines, edge banding, packaging, and assembly work where quick setting time and reliable strength are critical.",
          "Unlike solvent-based adhesives, hot melt adhesives contain no water or solvents, which means:",
        ],
        bullets: [
          "Faster bonding and reduced production downtime",
          "No drying or curing wait time",
          "Lower VOC emissions and safer handling",
          "Consistent performance across varying humidity and temperature conditions",
        ],
      },
      {
        title: "Why Choose Stick-Onn as Your Hot Melt Adhesive Supplier",
        paragraphs: [
          "As a dedicated hot melt adhesive manufacturer in India, Stick-Onn combines scientific formulation with hands-on technical support to solve real bonding challenges on the shop floor.",
        ],
      },
      {
        title: "Precision-Engineered Formulations",
        layout: "card",
        paragraphs: [
          "Every batch is formulated to meet consistent viscosity, open time, and bond strength standards — so your production line runs without unexpected failures or rework.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Rather than offering one generic formula, Stick-Onn develops hot melt adhesive grades tailored to specific substrates and processes — including wood, laminate, packaging board, and composite materials.",
        ],
      },
      {
        title: "Dedicated Technical Support",
        layout: "card",
        paragraphs: [
          "From substrate consultation to trial runs and line optimization, Stick-Onn's technical team works directly with manufacturers to select and fine-tune the right adhesive grade before full-scale rollout.",
        ],
      },
      {
        title: "Pan-India Supply Network",
        layout: "card",
        paragraphs: [
          "With a network of 120+ dealers across India, Stick-Onn ensures consistent product availability and fast replenishment for manufacturers and workshops nationwide — making it a dependable hot melt adhesive supplier for both small workshops and large-scale OEM operations.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Formulations are benchmarked against ISO and EN quality standards, ensuring every batch delivers the same performance, batch after batch.",
        ],
      },
      {
        title: "Applications of Stick-Onn Hot Melt Adhesives",
        paragraphs: [
          "Stick-Onn hot melt adhesives are used across a wide range of industries, including:",
        ],
        bullets: [
          "Furniture Manufacturing – edge banding, panel assembly, and lamination",
          "Packaging – carton sealing, case erecting, and box closing",
          "Woodworking & Carpentry – veneer and laminate bonding",
          "Automotive & Upholstery – foam and fabric lamination",
          "General Industrial Assembly – component bonding for OEM production lines",
        ],
      },
      {
        title: "Our Hot Melt Adhesive Range",
        paragraphs: [
          "Stick-Onn offers hot melt adhesive formulations suited to different bonding needs, including:",
        ],
        bullets: [
          "Standard-grade hot melt adhesives for general assembly and packaging",
          "High-temperature resistant grades for demanding industrial environments",
          "Fast-set formulations for high-speed production lines",
      ...
      },
      {
        title: "Manufacturing Quality & Consistency",
        paragraphs: [
          "Stick-Onn adhesives are manufactured under strict quality control processes, with each formulation tested for viscosity, bond strength, open time, and thermal stability before dispatch. This ensures every drum or unit that reaches a customer performs exactly as expected — batch after batch, order after order.",
        ],
      },
    ],
    ...
    productShowcase: [
      {
        ...
        description:
          "EVA-based hot melt pellets for edge banding and PVC sheet bonding. Ideal for carpenters, small workshops, and manual edge banding operations.",
        image: "/images/products/hotmelt-1kg.png",
        href: "/products/hotmelt",
        badge: "Best for edge banding",
      },
      {
        name: "Hot Melt Adhesive — Throughfeed 30 KG",
        description:
          "Industrial-grade formulation for automatic throughfeed edge banding machines. Instant bond, high melting power, and clean application for high-volume furniture lines.",
        image: "/images/products/hotmelt-throughfeed-30kg.png",
        href: "/products/hotmelt",
        badge: "Machine application",
      },
      {
        name: "Hot Melt Adhesive — Manual 30 KG",
        description:
          "EVA-based industrial grade hot melt for manual edge banding and PVC sheet bonding. High holding power with fast setting for production workshops.",
    ...
    faqs: [
      {
        question: "Who is the best hot melt adhesive manufacturer in India?",
        answer:
          "Stick-Onn is a trusted hot melt adhesive manufacturer in India, known for consistent quality, application-specific formulations, and dedicated technical support for furniture, packaging, and industrial manufacturers.",
      },
      {
        question: "What industries use hot melt adhesives?",
        answer:
          "Hot melt adhesives are widely used in furniture manufacturing, packaging, woodworking, automotive upholstery, and general industrial assembly due to their fast-setting properties and strong bond.",
      },
      {
        question: "Is hot melt adhesive suitable for high-volume production?",
        answer:
          "Yes. Hot melt adhesives are specifically designed for high-speed production lines because they set quickly and require no drying or curing time, minimizing downtime.",
      },
      {
        question: "Does Stick-Onn supply hot melt adhesives pan-India?",
        answer:
          "Yes, Stick-Onn supplies hot melt adhesives across India through a network of 120+ dealers, ensuring consistent availability for manufacturers and workshops nationwide.",
      },
    ],
    relatedLinks: [
      { href: "/products/hotmelt", label: "View Stick-Onn Hot Melt products" },
      { href: "/applications/furniture-manufacturing", label: "Furniture manufacturing applications" },
  ...
  },
  {
    ...
    seoDescription:
      "Stick-Onn is a leading polyurethane adhesive manufacturer in India, offering high-strength 1K PUR adhesives for wood, composite & industrial bonding. Get a quote today.",
    keywords: [
      "polyurethane adhesive manufacturer India",
      "PUR adhesive supplier",
      "polyurethane adhesive manufacturer",
      "1K PUR adhesive India",
      "moisture curing PUR adhesive",
      "polyurethane reactive adhesive",
      "PUR wood glue manufacturer",
      "Stick-Onn PUR adhesive",
      "WPC bonding adhesive",
      "industrial polyurethane adhesive India",
    ],
    ...
    midPageCta: {
      ...
      description:
        "Share your substrate combination and assembly process — our technical team will recommend the optimal polyurethane formulation.",
      productName: "1K PUR Adhesive",
    },
    bottomCta: {
      title: "Looking for a Polyurethane Adhesive Supplier You Can Trust?",
      description:
        "Whether you need structural bonding strength, moisture resistance, or flexibility under stress, Stick-Onn's polyurethane adhesive range is engineered to perform. Connect with our technical team for a formulation consultation or product trial.",
      productName: "1K PUR Adhesive",
    },
    sections: [
      {
        title: "What is Polyurethane Adhesive?",
        paragraphs: [
          "Polyurethane adhesive, often referred to as PUR adhesive, is a moisture-curing bonding agent known for its exceptional strength, flexibility, and resistance to water, heat, and chemicals. Unlike standard adhesives, PUR adhesives cure through a chemical reaction with atmospheric moisture, forming a tough, permanent bond that can withstand demanding environmental and mechanical stress.",
          "Key characteristics of polyurethane adhesives include:",
        ],
        bullets: [
          "High initial tack and strong final bond strength",
          "Excellent flexibility even after curing, resisting cracking under stress",
          "Strong resistance to moisture, heat, and chemicals",
          "Effective bonding across dissimilar substrates (wood, metal, plastic, composites)",
          "Long-term durability in demanding industrial applications",
        ],
      },
      {
        title: "Why Choose Stick-Onn as Your Polyurethane Adhesive Supplier",
        paragraphs: [
          "As a specialized PUR adhesive manufacturer, Stick-Onn engineers polyurethane formulations that meet the rigorous demands of modern manufacturing while offering the technical guidance needed to apply them correctly.",
        ],
      },
      {
        title: "Advanced Moisture-Curing Technology",
        layout: "card",
        paragraphs: [
          "Stick-Onn's 1K PUR adhesive range uses single-component, moisture-curing technology that eliminates the need for complex mixing — simplifying application while delivering industrial-grade bond strength.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Formulated for high-strength, high-durability requirements, Stick-Onn's polyurethane adhesives are suited for applications where standard adhesives fall short — including structural bonding, load-bearing joints, and moisture-prone environments.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Rather than a one-size-fits-all approach, Stick-Onn develops polyurethane adhesive grades tailored to specific substrate combinations and production processes, ensuring optimal adhesion and performance.",
        ],
      },
      {
        title: "Dedicated Technical Support",
        layout: "card",
        paragraphs: [
          "Stick-Onn's technical team works directly with manufacturers — from substrate consultation through trial runs and line optimization — to identify the right PUR adhesive formulation before full-scale production.",
        ],
      },
      {
        title: "Pan-India Supply Network",
        layout: "card",
        paragraphs: [
          "With a network of 120+ dealers across India, Stick-Onn ensures manufacturers and workshops nationwide have reliable, consistent access to polyurethane adhesives, making it a trusted polyurethane adhesive supplier for both small workshops and large OEM operations.",
        ],
      },
      {
        title: "Consistent, Benchmarked Quality",
        layout: "card",
        paragraphs: [
          "Every batch of Stick-Onn's polyurethane adhesive is tested against ISO and EN quality standards, ensuring uniform performance across every order.",
        ],
      },
      {
        title: "Applications of Stick-Onn Polyurethane Adhesives",
        paragraphs: [
          "Stick-Onn's PUR adhesives are used across a range of demanding applications, including:",
        ],
        bullets: [
          ...
          "Wood-Plastic Composite (WPC) Applications – high-grab bonding for WPC boards and profiles",
      ...
      {
        title: "Polyurethane Adhesive Range",
        paragraphs: [
          "Stick-Onn's polyurethane adhesive offering includes:",
        ],
        bullets: [
      ...
      },
      {
        title: "Manufacturing Quality & Consistency",
        paragraphs: [
          "Every batch of Stick-Onn polyurethane adhesive undergoes strict quality control, with testing for cure time, bond strength, viscosity, and moisture resistance before dispatch — ensuring dependable performance across every production run.",
        ],
      },
    ],
    ...
    faqs: [
      {
        question: "Who is a trusted polyurethane adhesive manufacturer in India?",
        answer:
          "Stick-Onn is a specialized polyurethane adhesive manufacturer in India, offering moisture-curing PUR adhesives backed by technical consultation and consistent quality for furniture and industrial manufacturers.",
      },
      {
        question: "What makes PUR adhesive different from other adhesives?",
        answer:
          "PUR (polyurethane reactive) adhesive cures through a reaction with atmospheric moisture, forming a strong, flexible, and highly durable bond that resists water, heat, and chemical exposure better than many conventional adhesives.",
      },
      {
        question: "Where is polyurethane adhesive commonly used?",
        answer:
          "Polyurethane adhesives are commonly used in furniture manufacturing, modular fit-outs, WPC applications, and industrial fabrication where strong, durable, and moisture-resistant bonds are required.",
      },
      {
        question: "Is Stick-Onn's polyurethane adhesive suitable for structural bonding?",
        answer:
          "Yes. Stick-Onn's 1K PUR adhesive is engineered for high-strength, load-bearing applications, making it suitable for structural and demanding industrial bonding needs.",
      },
      {
        question: "Does Stick-Onn supply polyurethane adhesive across India?",
        answer:
          "Yes, Stick-Onn supplies polyurethane adhesives nationwide through a network of 120+ dealers, ensuring consistent availability for manufacturers and workshops across India.",
      },
    ],
    relatedLinks: [
      ...
      { href: "/applications/furniture-manufacturing", label: "Furniture manufacturing solutions" },
      { href: "/contact", label: "Request a quote or product trial" },
    ],
  },
  {
    ...
    keywords: [
      "D3 adhesive manufacturer India",
      "D3 adhesive supplier",
      "D3 wood adhesive manufacturer",
      "EN 204 D3 adhesive",
      "export grade wood glue India",
      "Clout D3 adhesive",
      "modular kitchen adhesive",
      "D3 grade wood glue",
      "furniture adhesive manufacturer India",
      "Stick-Onn D3 adhesive",
    ],
    ...
    midPageCta: {
      title: "Need help with D3 bonding for export furniture?",
      description:
        "Share your substrate, assembly process, and quality requirements — our technical team will guide you on Clout D3 application and curing.",
      productName: "Clout D3 Adhesive",
    },
    bottomCta: {
      title: "Looking for a D3 Adhesive Manufacturer You Can Trust?",
      description:
        "Whether you're producing modular furniture for the domestic market or export-quality pieces that need to meet international standards, Stick-Onn's D3 adhesive is engineered to deliver. Connect with our technical team for a formulation consultation or product trial.",
      productName: "Clout D3 Adhesive",
    },
    sections: [
      {
        title: "What is D3 Adhesive?",
        paragraphs: [
          "D3 adhesive refers to a wood adhesive classification under the EN 204/205 standard, indicating moisture resistance suitable for interior applications with occasional short-term exposure to water or high humidity, such as kitchens, bathrooms, and furniture exposed to fluctuating moisture levels. D3-grade adhesives are widely regarded as a benchmark for quality in furniture manufacturing, particularly for export-oriented production where international durability standards must be met.",
          "Key characteristics of D3 adhesive include:",
        ],
        bullets: [
          "Moisture resistance suitable for humid or occasionally wet conditions",
          "Strong, durable bond that withstands temperature and humidity fluctuations",
          "Compliance with EN 204/205 D3 classification for quality assurance",
          "Ideal for furniture requiring long-term structural integrity",
          "Suitable for both domestic and export-quality manufacturing",
        ],
      },
      {
        title: "Why Choose Stick-Onn as Your D3 Adhesive Supplier",
        paragraphs: [
          "As a specialized D3 adhesive manufacturer, Stick-Onn engineers wood adhesive formulations that meet global quality benchmarks while ensuring ease of use on the shop floor.",
        ],
      },
      {
        title: "EN-Standard Compliant Formulation",
        layout: "card",
        paragraphs: [
          "Stick-Onn Clout D3 is formulated to meet D3-grade moisture resistance standards, giving furniture manufacturers the confidence to produce for both domestic and export markets.",
        ],
      },
      {
        title: "High-Strength, Long-Lasting Bonds",
        layout: "card",
        paragraphs: [
          "Engineered for demanding furniture applications, Stick-Onn's D3 adhesive delivers strong initial tack and long-term bond durability, even under humidity and temperature stress.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "Stick-Onn's technical team works directly with carpenters and manufacturers to guide substrate selection, application technique, and curing conditions, ensuring optimal results for every project.",
        ],
      },
      {
        ...
        layout: "card",
        paragraphs: [
          "From initial consultation to trial runs and on-site support, Stick-Onn helps manufacturers fine-tune their bonding process before scaling up production.",
        ],
      },
      {
        title: "Pan-India Supply Network",
        layout: "card",
        paragraphs: [
          "With a network of 120+ dealers across India, Stick-Onn ensures consistent availability of D3 adhesive for workshops, carpenters, and furniture manufacturers nationwide.",
        ],
      },
      {
        title: "Consistent, Benchmarked Quality",
        layout: "card",
        paragraphs: [
          "Every batch of Stick-Onn's D3 adhesive is tested against ISO and EN quality standards, ensuring uniform performance and reliability across every order.",
        ],
      },
      {
        title: "Applications of Stick-Onn D3 Adhesive",
        paragraphs: [
          "Stick-Onn's D3-grade adhesive is used across a range of furniture and woodworking applications, including:",
        ],
        bullets: [
          "Modular Furniture Manufacturing – kitchen cabinets, wardrobes, and modular units",
          "Export-Quality Furniture Production – meeting international moisture-resistance benchmarks",
          "Bathroom & Kitchen Furniture – bonding in high-humidity environments",
          "Joinery & Woodworking – panel and joint bonding for long-term durability",
          "Fit-Out & Interior Projects – furniture requiring consistent structural strength",
        ],
      },
      {
        title: "D3 Adhesive Range",
        paragraphs: ["Stick-Onn's D3-grade adhesive offering includes:"],
        bullets: [
          "Stick-Onn Clout D3 – D3-grade wood adhesive engineered for high-strength, export-quality furniture builds",
        ],
      },
      {
        title: "Manufacturing Quality & Consistency",
        paragraphs: [
          "Every batch of Stick-Onn D3 adhesive undergoes rigorous quality control, with testing for bond strength, moisture resistance, and curing performance before dispatch — ensuring every batch meets export-grade reliability standards.",
        ],
      },
    ],
    ...
    productShowcase: [
      {
        ...
        description:
          "High-performance D3-grade wood adhesive with 2-hour fast drying, anti-termite protection, and high strength. Available in 900 g pouches and bulk drums for workshops and OEM lines.",
        image: "/images/products/clout-d3.png",
        href: "/products/clout-d3",
        badge: "2 hr fast drying",
      },
      {
        name: "Stick-Onn Aqua Adhesive",
        description:
          "Rapid-cure waterproof wood adhesive for on-site kitchen and bathroom carpentry — complements Clout D3 on moisture-exposed fit-out projects.",
      ...
      },
      {
        name: "Stick-Onn 1K PUR Adhesive",
        description:
          "Moisture-curing polyurethane for structural and exterior-grade joints where D3 PVA alone is not sufficient — ideal alongside Clout D3 in a complete portfolio.",
        image: "/images/products/stick-onn-pur-adhesive.png",
        href: "/products/stick-onn-pur-adhesive",
    ...
    faqs: [
      {
        question: "Who is a trusted D3 adhesive manufacturer in India?",
        answer:
          "Stick-Onn is a specialized D3 adhesive manufacturer in India, offering EN-standard compliant wood adhesives backed by technical support for furniture and export-quality manufacturing.",
      },
      {
        question: "What does D3 grade mean in wood adhesive?",
        answer:
          "D3 grade, under the EN 204/205 classification, indicates moisture resistance suitable for interior applications with occasional exposure to water or humidity, such as kitchens and bathrooms.",
      },
      {
        question: "Is D3 adhesive suitable for export-quality furniture?",
        answer:
          "Yes. D3-grade adhesive is widely used in export-oriented furniture manufacturing because it meets international moisture-resistance and durability standards.",
      },
      {
        question: "Where is Stick-Onn's D3 adhesive commonly used?",
        answer:
          "Stick-Onn's D3 adhesive, Clout D3, is commonly used in modular furniture, kitchen and bathroom furniture, joinery, and fit-out projects requiring long-term structural strength.",
      },
      {
        question: "Does Stick-Onn supply D3 adhesive across India?",
        answer:
          "Yes, Stick-Onn supplies D3-grade adhesive nationwide through a network of 120+ dealers, ensuring consistent availability for carpenters and furniture manufacturers across India.",
      },
    ],
    relatedLinks: [
