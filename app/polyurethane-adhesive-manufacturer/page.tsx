...
const SLUG = "polyurethane-adhesive-manufacturer";
...
export const metadata = page
  ? createPageMetadata({
      ...
      images: [
        "/images/products/stick-onn-pur-adhesive.png",
        "/images/products/stick-onn-pur-adhesive-front-back.png",
      ],
    })
  : {};

export default function PolyurethaneAdhesiveManufacturerPage() {
  if (!page) notFound();
